    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className={`${
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-blue-100'} text-center mt-2 text-sm sm:text-base`}>
            Upload an image to detect and analyze objects within it
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 flex flex-col items-center justify-center max-w-7xl">
        {!previewUrl && (
          ...
          } p-6 sm:p-8 rounded-2xl shadow-xl flex flex-col items-center w-full max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-3xl mb-6 sm:mb-8 transform transition-all duration-300 hover:shadow-2xl`}>
            <label 
